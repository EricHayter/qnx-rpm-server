 ...
 * organizing processes into logical groups. This allows for better
 * organization, collective management, and reporting on sets of related
 * processes.
 */
...
// ProcessInfo is now directly in qnx namespace, forward declaration might not
// be needed if ProcessControl.hpp is included, but safer to keep it if used
// before include.
struct ProcessInfo;
...
public:
   ...
   */
  int createGroup(std::string_view name, int priority,
