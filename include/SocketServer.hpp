...
namespace qnx
{
    namespace network
    {
         ...
         *
         * These constants define the supported message types that clients can
         * send to the server. Each message type corresponds to a specific
         * action or request that the server can handle.
         */
        // Define message types (could be an enum class for better type safety)
        const std::string MSG_GET_PROCESSES = "GetProcesses";                     ///< Request a list of all running processes
        const std::string MSG_GET_SIMPLE_DETAILS = "GetSimpleProcessDetails";     ///< Request basic details about a specific process
        const std::string MSG_GET_DETAILED_DETAILS = "GetDetailedProcessDetails"; ///< Request detailed history for a specific process
        const std::string MSG_SUSPEND_PROCESS = "SuspendProcess";                 ///< Request to suspend a specific process
        const std::string MSG_RESUME_PROCESS = "ResumeProcess";                   ///< Request to resume a suspended process
        const std::string MSG_TERMINATE_PROCESS = "TerminateProcess";             ///< Request to terminate a specific process
        const std::string MSG_AUTH_LOGIN = "Login";                               ///< Authentication request with username and password
